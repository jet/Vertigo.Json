...
[<assembly: AssemblyVersionAttribute("0.1.60")>]
[<assembly: AssemblyFileVersionAttribute("0.1.60")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.1.60"
    let [<Literal>] AssemblyFileVersion = "0.1.60"
