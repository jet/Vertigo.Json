...
[<assembly: AssemblyVersionAttribute("0.1.65")>]
[<assembly: AssemblyFileVersionAttribute("0.1.65")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.1.65"
    let [<Literal>] AssemblyFileVersion = "0.1.65"
